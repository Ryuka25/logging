...
SECRET_KEY = 'django-insecure-i%m988lm#$zi(nfg2^_@fni=er+8uy4eo2qndfagkp2$mtt+6$'
...
LOGGING = {
    ...
    # A handler for WARNING. It is basicallyy writing the WARNING
    # message into a file called WARNING.log
    'handlers': {
        'file': {
            'level': 'WARNING',
    ...
    'loggers': {
        ...
        '': {
            'handlers': ['file'],
            # notithe how file variable is called in handler which has been defined above
            'level': 'WARNING',
            'propagate': True,
        },
    },
